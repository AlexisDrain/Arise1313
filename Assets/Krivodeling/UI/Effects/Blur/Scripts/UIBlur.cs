...
namespace Krivodeling.UI.Effects
{
    public class UIBlur : MonoBehaviour
    {
        ...
        public float Intensity { get => _intensity; set { _intensity = Mathf.Clamp(value, 0f, 2f); UpdateIntensity(); } }
        public float Multiplier { get => _multiplier; set { _multiplier = Mathf.Clamp(value, 0f, 2f); UpdateMultiplier(); } }
